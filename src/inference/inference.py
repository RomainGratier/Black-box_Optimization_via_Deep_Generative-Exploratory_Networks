...
def compute_quantitative_and_qualitative_inference(target, metrics=['optimization', 'qualitative', 'fid_kid', 'l1_l2'], distributions=['in', 'out'], bayesian_model_types=["lrt"], activation_types=["softplus", "relu"], output_type='latex', decimals=2):
