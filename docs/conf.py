...
htmlhelp_basename = 'Black-box_Optimization_via _Deep_Generative-Exploratory_Networksdoc'
...
latex_documents = [
    ('index',
     'Black-box_Optimization_via _Deep_Generative-Exploratory_Networks.tex',
     u'project_name Documentation',
     u"romain gratier", 'manual'),
]
...
man_pages = [
    ('index', 'Black-box_Optimization_via _Deep_Generative-Exploratory_Networks', u'project_name Documentation',
     [u"romain gratier"], 1)
]
