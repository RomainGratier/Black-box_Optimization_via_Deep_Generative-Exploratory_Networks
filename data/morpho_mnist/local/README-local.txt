Morpho-MNIST: 'Local' dataset
=============================

This dataset corresponds to a random interleaving of plain, swollen and
fractured MNIST digits. It consists of the following files:
