...
from src_min_mnist.generative_model import Generator, Discriminator, LeNet5
...
def compute_fid_kid_for_mnist(generator, n_row, real_dataset_in, real_dataset_out, index_in_distribution, index_out_distribution, sample_size):
    ...
    gen_img_in_distribution = generate_sample(cfg.limit_dataset, cfg.max_dataset, sample_size, generator)
    gen_img_out_distribution = generate_sample(cfg.min_dataset, cfg.limit_dataset, sample_size, generator)
